...
class _MyTicketDetailViewState extends State<MyTicketDetailView> {
  ...
  void initState() {
    super.initState();
    myTicketDetailViewModel = Provider.of<MyTicketDetailViewModel>(context, listen: false);
  }
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TicketItem(
                          title: 'نام کاربر',
                          text: myTicketDetailViewModel.ticket.user.username,
                        ),
                      ),
                      Expanded(
                        child: TicketItem(
                    ...
                    children: [
                      Expanded(
                        child: TicketItem(
                          title: 'مبدا',
                          text:
                              myTicketDetailViewModel.ticket.travelDetail.source.title,
                        ),
                      ),
                      Expanded(
                        child: TicketItem(
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TicketItem(
                          title: 'قیمت',
                          text: myTicketDetailViewModel.ticket.travelDetail.price
                                  .toString() +
                              ' تومان',
                        ),
                      ),
